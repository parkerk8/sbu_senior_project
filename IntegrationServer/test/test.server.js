...
it('should correctly load OAuth credentials from a file', function() {
  ...
  const fs = require('fs');
  const token = { access_token: '84218033259-mvplo5l57j3pkagfot7f197eb43efrqn.apps.googleusercontent.com', refresh_token: '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', expires_in: 3600 };
